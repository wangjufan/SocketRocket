...
return null},Vc=!1;if(F.querySelectorAll)try{var Wc=F.querySelectorAll(":root");Wc&&1==Wc.length&&Wc[0]==F.documentElement&&(Vc=!0)}catch(a){}var Sc=Vc;var jd={},kd=null,ld=Math.random();jd.s="GTM-PP63D5";jd.Nb="5k1";jd.Ld="";var md={__cl:!0,__ecl:!0,__ehl:!0,__evl:!0,__fal:!0,__fil:!0,__fsl:!0,__hl:!0,__jel:!0,__lcl:!0,__sdl:!0,__tl:!0,__ytl:!0,__paused:!0,__tg:!0},od="www.googletagmanager.com/gtm.js";
var pd=od,qd=null,rd=null,sd=null,td="//www.googletagmanager.com/a?id="+jd.s+"&cv=52",ud={},vd={},wd=function(){var a=kd.sequence||0;kd.sequence=a+1;return a};
...
W.a.cl=["google"],function(){function a(b){var c=b.target;if(c){var d=dk(c,"gtm.click");Pk(d)}}(function(b){W.__cl=b;W.__cl.b="cl";W.__cl.g=!0;W.__cl.priorityOverride=0})(function(b){if(!Tk("cl")){var c=R("document");nc(c,"click",a,!0);Uk("cl")}G(b.vtp_gtmOnSuccess)})}();W.a.k=["google"],function(){(function(a){W.__k=a;W.__k.b="k";W.__k.g=!0;W.__k.priorityOverride=0})(function(a){return Rk(a.vtp_name,Q("gtm.cookie",1),!!a.vtp_decodeCookie)[0]})}();
...
f.value)};z(M,N,!1);x("send",N);}else if("TRACK_SOCIAL"==e.vtp_trackType){}else if("TRACK_TRANSACTION"==e.vtp_trackType){
x("require","ecommerce","//www.google-analytics.com/plugins/ua/ecommerce.js");var Y=function(O){return Q("transaction"+O,1)},ta=Y("Id");x("ecommerce:addTransaction",{id:ta,affiliation:Y("Affiliation"),revenue:Y("Total"),shipping:Y("Shipping"),tax:Y("Tax")});for(var S=Y("Products")||[],L=0;L<S.length;L++){var J=S[L];x("ecommerce:addItem",{id:ta,sku:J.sku,name:J.name,category:J.category,price:J.price,quantity:J.quantity})}x("ecommerce:send");}else if("TRACK_TIMING"==
